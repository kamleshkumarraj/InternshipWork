...
function SideMenu() {
  ...
  return (
    ...
    <div id="menu" className="flex flex-col 2xl:mt-[40px] xl:mt-[36px] lg:mt-[32px] md:mt-[30px] sm:mt-[27px] mt-[25px] gap-[20px] xl:px-[70px] px-[40px] md:py-[40px] py-[20px]">
        ...
        <NavLink to={'/products'} className={(status) => navHandler(status.isActive)+'2xl:w-[260px] xl:w-[250px] sm:w-[220px] w-[180px]  md:w-[full] h-[58px] flex items-center gap-[15px] px-[40px]'}>
        ...
        <NavLink to={'/orders'} className={(status) => navHandler(status.isActive)+'2xl:w-[260px] xl:w-[250px] sm:w-[220px] w-[180px]  md:w-[full] h-[58px] flex items-center gap-[15px] px-[40px]'}>
        ...
        <NavLink to={'/customers'} className={(status) => navHandler(status.isActive)+'2xl:w-[260px] xl:w-[250px] sm:w-[220px] w-[180px]  md:w-[full] h-[58px] flex items-center gap-[15px] px-[40px]'}>
        ...
        <NavLink to={'/sign-out'} className={(status) => navHandler(status.isActive)+'2xl:w-[260px] xl:w-[250px] sm:w-[220px] w-[180px]  md:w-[full] h-[58px] flex items-center gap-[15px] px-[40px]'}>
