...
import logo from '../assets/Common/Logo/header-logo.svg'
import { VscChevronRight } from 'react-icons/vsc'
function Header() {
  return (
    <div id="admin-header" className="w-full bg-[#524BAD] 2xl:px-[140px] xl:px-[100px] lg:px-[70px] md:px-[50px] sm:px-[40px] px-[20px] py-[20px] sm:py-[25px] flex justify-between text-[#fff] items-center">
